...
INSERT INTO machines (serial_no, type, variant, protocol, base_url) VALUES
('AG-294751', 'AGV',              '',          'rest', 'http://localhost:8082/v1/status/'),
('AG-183640', 'AGV',              '',          'rest', 'http://localhost:8083/v1/status/'),
('AG-572913', 'AGV',              '',          'rest', 'http://localhost:8084/v1/status/'),
('AG-846203', 'AGV',              '',          'rest', 'http://localhost:8085/v1/status/'),
('AG-731485', 'AGV',              '',          'rest', 'http://localhost:8086/v1/status/'),
('WH-P13752', 'WAREHOUSE',        'parts',     'soap', 'http://localhost:8087/Service.asmx'),
('WH-P47281', 'WAREHOUSE',        'parts',     'soap', 'http://localhost:8088/Service.asmx'),
('WH-A64819', 'WAREHOUSE',        'accepted',  'soap', 'http://localhost:8089/Service.asmx'),
('WH-A29047', 'WAREHOUSE',        'accepted',  'soap', 'http://localhost:8090/Service.asmx'),
('WH-D81234', 'WAREHOUSE',        'defect',    'soap', 'http://localhost:8091/Service.asmx'),
('WH-D02765', 'WAREHOUSE',        'defect',    'soap', 'http://localhost:8092/Service.asmx'),
('AS-917346', 'ASSEMBLY_STATION', '',          'mqtt', NULL);
